    ...
    <div id="keepInTouch" className="rowContainer">
      {/* <div > */}
        <div id="leftComponent" className="rowContainer">
          <div className="rowContainer">
            <span className="material-icons contactIcon">location_on</span>
          ...
          <div className="rowContainer">
            <span className="material-icons contactIcon">phone</span>
      ...
      <div id="rightComponent">
        <form>
          ...
          <div id="contactButton" onClick={()=>console.log('submitted form')}>
            SUBMIT
